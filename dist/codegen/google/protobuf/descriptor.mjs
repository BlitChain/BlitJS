...
export const FileDescriptorSet = {
    ...
    fromSDK(object) {
        return {
            file: Array.isArray(object?.file) ? object.file.map((e) => FileDescriptorProto.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
...
export const FileDescriptorProto = {
    ...
    fromSDK(object) {
        return {
            ...
            message_type: Array.isArray(object?.message_type) ? object.message_type.map((e) => DescriptorProto.fromSDK(e)) : [],
            enum_type: Array.isArray(object?.enum_type) ? object.enum_type.map((e) => EnumDescriptorProto.fromSDK(e)) : [],
            service: Array.isArray(object?.service) ? object.service.map((e) => ServiceDescriptorProto.fromSDK(e)) : [],
            extension: Array.isArray(object?.extension) ? object.extension.map((e) => FieldDescriptorProto.fromSDK(e)) : [],
            options: object.options ? FileOptions.fromSDK(object.options) : undefined,
            source_code_info: object.source_code_info ? SourceCodeInfo.fromSDK(object.source_code_info) : undefined,
    ...
    toSDK(message) {
        ...
        if (message.message_type) {
            obj.message_type = message.message_type.map(e => e ? DescriptorProto.toSDK(e) : undefined);
        }
        else {
            obj.message_type = [];
        }
        if (message.enum_type) {
            obj.enum_type = message.enum_type.map(e => e ? EnumDescriptorProto.toSDK(e) : undefined);
        }
        else {
            obj.enum_type = [];
        }
        ...
        message.source_code_info !== undefined && (obj.source_code_info = message.source_code_info ? SourceCodeInfo.toSDK(message.source_code_info) : undefined);
...
export const DescriptorProto = {
    ...
    fromSDK(object) {
        return {
            name: object?.name,
            field: Array.isArray(object?.field) ? object.field.map((e) => FieldDescriptorProto.fromSDK(e)) : [],
            extension: Array.isArray(object?.extension) ? object.extension.map((e) => FieldDescriptorProto.fromSDK(e)) : [],
            nested_type: Array.isArray(object?.nested_type) ? object.nested_type.map((e) => DescriptorProto.fromSDK(e)) : [],
            enum_type: Array.isArray(object?.enum_type) ? object.enum_type.map((e) => EnumDescriptorProto.fromSDK(e)) : [],
            extension_range: Array.isArray(object?.extension_range) ? object.extension_range.map((e) => DescriptorProto_ExtensionRange.fromSDK(e)) : [],
            oneof_decl: Array.isArray(object?.oneof_decl) ? object.oneof_decl.map((e) => OneofDescriptorProto.fromSDK(e)) : [],
            options: object.options ? MessageOptions.fromSDK(object.options) : undefined,
            reserved_range: Array.isArray(object?.reserved_range) ? object.reserved_range.map((e) => DescriptorProto_ReservedRange.fromSDK(e)) : [],
    ...
    toSDK(message) {
        ...
        if (message.nested_type) {
            obj.nested_type = message.nested_type.map(e => e ? DescriptorProto.toSDK(e) : undefined);
        }
        else {
            obj.nested_type = [];
        }
        ...
        if (message.extension_range) {
            obj.extension_range = message.extension_range.map(e => e ? DescriptorProto_ExtensionRange.toSDK(e) : undefined);
        }
        else {
            obj.extension_range = [];
        }
        if (message.oneof_decl) {
            obj.oneof_decl = message.oneof_decl.map(e => e ? OneofDescriptorProto.toSDK(e) : undefined);
        }
        else {
            obj.oneof_decl = [];
        }
        ...
        if (message.reserved_range) {
            obj.reserved_range = message.reserved_range.map(e => e ? DescriptorProto_ReservedRange.toSDK(e) : undefined);
        }
        else {
            obj.reserved_range = [];
        }
...
export const ExtensionRangeOptions = {
    ...
    fromSDK(object) {
        return {
            uninterpreted_option: Array.isArray(object?.uninterpreted_option) ? object.uninterpreted_option.map((e) => UninterpretedOption.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        if (message.uninterpreted_option) {
            obj.uninterpreted_option = message.uninterpreted_option.map(e => e ? UninterpretedOption.toSDK(e) : undefined);
        }
        else {
            obj.uninterpreted_option = [];
        }
...
export const EnumDescriptorProto = {
    ...
    fromSDK(object) {
        return {
            name: object?.name,
            value: Array.isArray(object?.value) ? object.value.map((e) => EnumValueDescriptorProto.fromSDK(e)) : [],
            options: object.options ? EnumOptions.fromSDK(object.options) : undefined,
            reserved_range: Array.isArray(object?.reserved_range) ? object.reserved_range.map((e) => EnumDescriptorProto_EnumReservedRange.fromSDK(e)) : [],
            reserved_name: Array.isArray(object?.reserved_name) ? object.reserved_name.map((e) => e) : []
        };
    },
    toSDK(message) {
        ...
        if (message.reserved_range) {
            obj.reserved_range = message.reserved_range.map(e => e ? EnumDescriptorProto_EnumReservedRange.toSDK(e) : undefined);
        }
        else {
            obj.reserved_range = [];
        }
...
export const ServiceDescriptorProto = {
    ...
    fromSDK(object) {
        return {
            name: object?.name,
            method: Array.isArray(object?.method) ? object.method.map((e) => MethodDescriptorProto.fromSDK(e)) : [],
...
export const UninterpretedOption = {
    ...
    fromSDK(object) {
        return {
            name: Array.isArray(object?.name) ? object.name.map((e) => UninterpretedOption_NamePart.fromSDK(e)) : [],
    ...
    fromAmino(object) {
        return {
            ...
            identifier_value: object.identifier_value,
            positive_int_value: BigInt(object.positive_int_value),
            negative_int_value: BigInt(object.negative_int_value),
            double_value: object.double_value,
            string_value: object.string_value,
            aggregate_value: object.aggregate_value
        };
...
export const SourceCodeInfo = {
    ...
    fromSDK(object) {
        return {
            location: Array.isArray(object?.location) ? object.location.map((e) => SourceCodeInfo_Location.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
...
export const GeneratedCodeInfo = {
    ...
    fromSDK(object) {
        return {
            annotation: Array.isArray(object?.annotation) ? object.annotation.map((e) => GeneratedCodeInfo_Annotation.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
