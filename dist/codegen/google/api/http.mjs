...
export const Http = {
    ...
    fromSDK(object) {
        return {
            rules: Array.isArray(object?.rules) ? object.rules.map((e) => HttpRule.fromSDK(e)) : [],
...
export const HttpRule = {
    ...
    fromSDK(object) {
        return {
            ...
            additional_bindings: Array.isArray(object?.additional_bindings) ? object.additional_bindings.map((e) => HttpRule.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
    ...
    fromAmino(object) {
        return {
            ...
            body: object.body,
            response_body: object.response_body,
            additional_bindings: Array.isArray(object?.additional_bindings) ? object.additional_bindings.map((e) => HttpRule.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
