...
export const Pool = {
    ...
    fromJSON(object) {
        return {
            ...
            pool_liquidity: Array.isArray(object?.pool_liquidity) ? object.pool_liquidity.map((e) => Coin.fromJSON(e)) : [],
    ...
    fromSDK(object) {
        return {
            ...
            pool_liquidity: Array.isArray(object?.pool_liquidity) ? object.pool_liquidity.map((e) => Coin.fromSDK(e)) : [],
    ...
    fromAmino(object) {
        return {
            ...
            pool_liquidity: Array.isArray(object?.pool_liquidity) ? object.pool_liquidity.map((e) => Coin.fromAmino(e)) : [],
