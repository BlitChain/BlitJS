...
const osmosisSwaprouterV1beta1TxRegistry = __importStar(require("./swaprouter/v1beta1/tx.registry"));
const osmosisTokenfactoryV1beta1TxRegistry = __importStar(require("./tokenfactory/v1beta1/tx.registry"));
const osmosisValsetprefV1beta1TxRegistry = __importStar(require("./valset-pref/v1beta1/tx.registry"));
...
const osmosisSwaprouterV1beta1TxAmino = __importStar(require("./swaprouter/v1beta1/tx.amino"));
const osmosisTokenfactoryV1beta1TxAmino = __importStar(require("./tokenfactory/v1beta1/tx.amino"));
const osmosisValsetprefV1beta1TxAmino = __importStar(require("./valset-pref/v1beta1/tx.amino"));
