...
exports.MsgDelegateToValidatorSet = {
    ...
    fromJSON(object) {
        return {
            delegator: (0, helpers_1.isSet)(object.delegator) ? String(object.delegator) : "",
            coin: (0, helpers_1.isSet)(object.coin) ? coin_1.Coin.fromJSON(object.coin) : undefined
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromSDK(object) {
        return {
            delegator: object?.delegator,
            coin: object.coin ? coin_1.Coin.fromSDK(object.coin) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        obj.delegator = message.delegator;
        message.coin !== undefined && (obj.coin = message.coin ? coin_1.Coin.toSDK(message.coin) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
