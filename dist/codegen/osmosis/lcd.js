...
const createLCDClient = async ({ restEndpoint }) => {
    ...
    return {
        ...
        osmosis: {
            downtimedetector: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./downtime-detector/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            epochs: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./epochs/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            gamm: {
            ...
            ibcratelimit: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./ibc-rate-limit/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            ...
            poolincentives: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./pool-incentives/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            protorev: {
            ...
            swaprouter: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./swaprouter/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            tokenfactory: {
            ...
            valsetpref: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./valset-pref/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            }
        }
