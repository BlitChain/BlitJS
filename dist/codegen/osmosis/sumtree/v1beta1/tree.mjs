...
export const Node = {
    ...
    fromJSON(object) {
        return {
            children: Array.isArray(object?.children) ? object.children.map((e) => Child.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromSDK(object) {
        return {
            children: Array.isArray(object?.children) ? object.children.map((e) => Child.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
    ...
    fromAmino(object) {
        return {
            children: Array.isArray(object?.children) ? object.children.map((e) => Child.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
