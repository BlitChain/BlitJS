...
exports.MessageComposer = {
    ...
    toJSON: {
        setHotRoutes(value) {
            return {
                typeUrl: "/osmosis.protorev.v1beta1.MsgSetHotRoutes",
                value: tx_1.MsgSetHotRoutes.toJSON(value)
            };
        },
        setDeveloperAccount(value) {
            return {
                typeUrl: "/osmosis.protorev.v1beta1.MsgSetDeveloperAccount",
                value: tx_1.MsgSetDeveloperAccount.toJSON(value)
            };
        }
    },
    fromJSON: {
        setHotRoutes(value) {
            return {
                typeUrl: "/osmosis.protorev.v1beta1.MsgSetHotRoutes",
                value: tx_1.MsgSetHotRoutes.fromJSON(value)
            };
        },
        setDeveloperAccount(value) {
            return {
                typeUrl: "/osmosis.protorev.v1beta1.MsgSetDeveloperAccount",
                value: tx_1.MsgSetDeveloperAccount.fromJSON(value)
            };
        }
    },
    fromPartial: {
