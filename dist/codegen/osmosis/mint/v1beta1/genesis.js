...
function createBaseGenesisState() {
    return {
        ...
        reduction_started_epoch: BigInt(0)
    };
}
exports.GenesisState = {
    ...
    encode(message, writer = binary_1.BinaryWriter.create()) {
        ...
        if (message.reduction_started_epoch !== BigInt(0)) {
    ...
    fromJSON(object) {
        return {
            ...
            reduction_started_epoch: (0, helpers_1.isSet)(object.reduction_started_epoch) ? BigInt(object.reduction_started_epoch.toString()) : BigInt(0)
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.reduction_started_epoch !== undefined && (obj.reduction_started_epoch = (message.reduction_started_epoch || BigInt(0)).toString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseGenesisState();
        ...
        message.reduction_started_epoch = object.reduction_started_epoch !== undefined && object.reduction_started_epoch !== null ? BigInt(object.reduction_started_epoch.toString()) : BigInt(0);
        return message;
    },
    fromSDK(object) {
        return {
            ...
            reduction_started_epoch: object?.reduction_started_epoch
        };
    },
    toSDK(message) {
        const obj = {};
    ...
    fromAmino(object) {
        return {
            ...
            reduction_started_epoch: BigInt(object.reduction_started_epoch)
        };
    },
    toAmino(message) {
        const obj = {};
