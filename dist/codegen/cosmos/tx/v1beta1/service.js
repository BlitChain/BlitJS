...
exports.GetTxsEventResponse = {
    ...
    toSDK(message) {
        ...
        if (message.tx_responses) {
            obj.tx_responses = message.tx_responses.map(e => e ? abci_1.TxResponse.toSDK(e) : undefined);
        }
        else {
            obj.tx_responses = [];
        }
...
exports.BroadcastTxResponse = {
    ...
    fromSDK(object) {
        return {
            tx_response: object.tx_response ? abci_1.TxResponse.fromSDK(object.tx_response) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.tx_response !== undefined && (obj.tx_response = message.tx_response ? abci_1.TxResponse.toSDK(message.tx_response) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
...
exports.SimulateResponse = {
    ...
    fromSDK(object) {
        return {
            gas_info: object.gas_info ? abci_1.GasInfo.fromSDK(object.gas_info) : undefined,
            result: object.result ? abci_1.Result.fromSDK(object.result) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.gas_info !== undefined && (obj.gas_info = message.gas_info ? abci_1.GasInfo.toSDK(message.gas_info) : undefined);
