...
export const ValidatorOutstandingRewardsRecord = {
    ...
    fromSDK(object) {
        return {
            ...
            outstanding_rewards: Array.isArray(object?.outstanding_rewards) ? object.outstanding_rewards.map((e) => DecCoin.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
...
export const GenesisState = {
    ...
    fromSDK(object) {
        return {
            ...
            delegator_withdraw_infos: Array.isArray(object?.delegator_withdraw_infos) ? object.delegator_withdraw_infos.map((e) => DelegatorWithdrawInfo.fromSDK(e)) : [],
            previous_proposer: object?.previous_proposer,
            outstanding_rewards: Array.isArray(object?.outstanding_rewards) ? object.outstanding_rewards.map((e) => ValidatorOutstandingRewardsRecord.fromSDK(e)) : [],
            validator_accumulated_commissions: Array.isArray(object?.validator_accumulated_commissions) ? object.validator_accumulated_commissions.map((e) => ValidatorAccumulatedCommissionRecord.fromSDK(e)) : [],
            validator_historical_rewards: Array.isArray(object?.validator_historical_rewards) ? object.validator_historical_rewards.map((e) => ValidatorHistoricalRewardsRecord.fromSDK(e)) : [],
            validator_current_rewards: Array.isArray(object?.validator_current_rewards) ? object.validator_current_rewards.map((e) => ValidatorCurrentRewardsRecord.fromSDK(e)) : [],
            delegator_starting_infos: Array.isArray(object?.delegator_starting_infos) ? object.delegator_starting_infos.map((e) => DelegatorStartingInfoRecord.fromSDK(e)) : [],
            validator_slash_events: Array.isArray(object?.validator_slash_events) ? object.validator_slash_events.map((e) => ValidatorSlashEventRecord.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
