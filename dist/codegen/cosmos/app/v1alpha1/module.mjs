...
export const ModuleDescriptor = {
    ...
    fromSDK(object) {
        return {
            ...
            use_package: Array.isArray(object?.use_package) ? object.use_package.map((e) => PackageReference.fromSDK(e)) : [],
            can_migrate_from: Array.isArray(object?.can_migrate_from) ? object.can_migrate_from.map((e) => MigrateFromInfo.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
    ...
    fromAmino(object) {
        return {
            go_import: object.go_import,
            use_package: Array.isArray(object?.use_package) ? object.use_package.map((e) => PackageReference.fromAmino(e)) : [],
            can_migrate_from: Array.isArray(object?.can_migrate_from) ? object.can_migrate_from.map((e) => MigrateFromInfo.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
