...
exports.ModuleAccount = {
    ...
    fromSDK(object) {
        return {
            base_account: object.base_account ? exports.BaseAccount.fromSDK(object.base_account) : undefined,
            name: object?.name,
    ...
    toSDK(message) {
        const obj = {};
        message.base_account !== undefined && (obj.base_account = message.base_account ? exports.BaseAccount.toSDK(message.base_account) : undefined);
