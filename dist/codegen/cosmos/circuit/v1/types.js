...
exports.GenesisAccountPermissions = {
    ...
    fromSDK(object) {
        return {
            ...
            permissions: object.permissions ? exports.Permissions.fromSDK(object.permissions) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        obj.address = message.address;
        message.permissions !== undefined && (obj.permissions = message.permissions ? exports.Permissions.toSDK(message.permissions) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
...
exports.GenesisState = {
    ...
    fromSDK(object) {
        return {
            account_permissions: Array.isArray(object?.account_permissions) ? object.account_permissions.map((e) => exports.GenesisAccountPermissions.fromSDK(e)) : [],
    ...
    toSDK(message) {
        const obj = {};
        if (message.account_permissions) {
            obj.account_permissions = message.account_permissions.map(e => e ? exports.GenesisAccountPermissions.toSDK(e) : undefined);
        }
        else {
            obj.account_permissions = [];
        }
