...
exports.AccountResponse = {
    ...
    fromSDK(object) {
        return {
            permission: object.permission ? types_1.Permissions.fromSDK(object.permission) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.permission !== undefined && (obj.permission = message.permission ? types_1.Permissions.toSDK(message.permission) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
...
exports.AccountsResponse = {
    ...
    fromSDK(object) {
        return {
            accounts: Array.isArray(object?.accounts) ? object.accounts.map((e) => types_1.GenesisAccountPermissions.fromSDK(e)) : [],
    ...
    toSDK(message) {
        const obj = {};
        if (message.accounts) {
            obj.accounts = message.accounts.map(e => e ? types_1.GenesisAccountPermissions.toSDK(e) : undefined);
        }
        else {
            obj.accounts = [];
        }
