...
exports.MsgAuthorizeCircuitBreaker = {
    ...
    fromSDK(object) {
        return {
            ...
            permissions: object.permissions ? types_1.Permissions.fromSDK(object.permissions) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        message.permissions !== undefined && (obj.permissions = message.permissions ? types_1.Permissions.toSDK(message.permissions) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
