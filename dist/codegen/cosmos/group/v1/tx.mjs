//@ts-nocheck
import { MemberRequest, ThresholdDecisionPolicy, PercentageDecisionPolicy, voteOptionFromJSON, voteOptionToJSON, proposalExecutorResultFromJSON, proposalExecutorResultToJSON } from "./types";
...
export const MsgCreateGroup = {
    ...
    fromSDK(object) {
        return {
            admin: object?.admin,
            members: Array.isArray(object?.members) ? object.members.map((e) => MemberRequest.fromSDK(e)) : [],
    ...
    fromAmino(object) {
        return {
            admin: object.admin,
            members: Array.isArray(object?.members) ? object.members.map((e) => MemberRequest.fromAmino(e)) : [],
            metadata: object.metadata
        };
    },
    toAmino(message) {
...
export const MsgUpdateGroupMembers = {
    ...
    fromSDK(object) {
        return {
            admin: object?.admin,
            group_id: object?.group_id,
            member_updates: Array.isArray(object?.member_updates) ? object.member_updates.map((e) => MemberRequest.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        obj.group_id = message.group_id;
        if (message.member_updates) {
            obj.member_updates = message.member_updates.map(e => e ? MemberRequest.toSDK(e) : undefined);
        }
        else {
            obj.member_updates = [];
        }
    ...
    fromAmino(object) {
        return {
            admin: object.admin,
            group_id: BigInt(object.group_id),
            member_updates: Array.isArray(object?.member_updates) ? object.member_updates.map((e) => MemberRequest.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
