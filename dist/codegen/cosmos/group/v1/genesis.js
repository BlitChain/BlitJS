...
exports.GenesisState = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.GenesisState.typeUrl || typeof o.group_seq === "bigint" && Array.isArray(o.groups) && (!o.groups.length || types_1.GroupInfo.is(o.groups[0])) && Array.isArray(o.group_members) && (!o.group_members.length || types_1.GroupMember.is(o.group_members[0])) && typeof o.group_policy_seq === "bigint" && Array.isArray(o.group_policies) && (!o.group_policies.length || types_1.GroupPolicyInfo.is(o.group_policies[0])) && typeof o.proposal_seq === "bigint" && Array.isArray(o.proposals) && (!o.proposals.length || types_1.Proposal.is(o.proposals[0])) && Array.isArray(o.votes) && (!o.votes.length || types_1.Vote.is(o.votes[0])));
    },
    isSDK(o) {
