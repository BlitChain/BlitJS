...
export const GenesisState = {
    ...
    fromSDK(object) {
        return {
            ...
            group_members: Array.isArray(object?.group_members) ? object.group_members.map((e) => GroupMember.fromSDK(e)) : [],
    ...
    fromAmino(object) {
        return {
            ...
            group_members: Array.isArray(object?.group_members) ? object.group_members.map((e) => GroupMember.fromAmino(e)) : [],
