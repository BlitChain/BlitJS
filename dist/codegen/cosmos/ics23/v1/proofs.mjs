...
export const ExistenceProof = {
    ...
    fromSDK(object) {
        return {
            ...
            path: Array.isArray(object?.path) ? object.path.map((e) => InnerOp.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
...
export const ProofSpec = {
    ...
    fromSDK(object) {
        return {
            leaf_spec: object.leaf_spec ? LeafOp.fromSDK(object.leaf_spec) : undefined,
            inner_spec: object.inner_spec ? InnerSpec.fromSDK(object.inner_spec) : undefined,
    ...
    toSDK(message) {
        const obj = {};
        message.leaf_spec !== undefined && (obj.leaf_spec = message.leaf_spec ? LeafOp.toSDK(message.leaf_spec) : undefined);
        message.inner_spec !== undefined && (obj.inner_spec = message.inner_spec ? InnerSpec.toSDK(message.inner_spec) : undefined);
...
export const BatchProof = {
    ...
    fromSDK(object) {
        return {
            entries: Array.isArray(object?.entries) ? object.entries.map((e) => BatchEntry.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
...
export const CompressedBatchProof = {
    ...
    fromSDK(object) {
        return {
            entries: Array.isArray(object?.entries) ? object.entries.map((e) => CompressedBatchEntry.fromSDK(e)) : [],
            lookup_inners: Array.isArray(object?.lookup_inners) ? object.lookup_inners.map((e) => InnerOp.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        if (message.lookup_inners) {
            obj.lookup_inners = message.lookup_inners.map(e => e ? InnerOp.toSDK(e) : undefined);
        }
        else {
            obj.lookup_inners = [];
        }
