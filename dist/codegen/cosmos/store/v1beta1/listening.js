...
exports.BlockMetadata = {
    ...
    fromSDK(object) {
        return {
            response_commit: object.response_commit ? types_1.ResponseCommit.fromSDK(object.response_commit) : undefined,
            request_finalize_block: object.request_finalize_block ? types_1.RequestFinalizeBlock.fromSDK(object.request_finalize_block) : undefined,
            response_finalize_block: object.response_finalize_block ? types_1.ResponseFinalizeBlock.fromSDK(object.response_finalize_block) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.response_commit !== undefined && (obj.response_commit = message.response_commit ? types_1.ResponseCommit.toSDK(message.response_commit) : undefined);
        message.request_finalize_block !== undefined && (obj.request_finalize_block = message.request_finalize_block ? types_1.RequestFinalizeBlock.toSDK(message.request_finalize_block) : undefined);
        message.response_finalize_block !== undefined && (obj.response_finalize_block = message.response_finalize_block ? types_1.ResponseFinalizeBlock.toSDK(message.response_finalize_block) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
