...
exports.SnapshotItem = {
    ...
    fromSDK(object) {
        return {
            ...
            extension_payload: object.extension_payload ? exports.SnapshotExtensionPayload.fromSDK(object.extension_payload) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        message.extension_payload !== undefined && (obj.extension_payload = message.extension_payload ? exports.SnapshotExtensionPayload.toSDK(message.extension_payload) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
