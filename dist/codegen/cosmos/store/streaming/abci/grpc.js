...
exports.ListenFinalizeBlockRequest = {
    ...
    fromSDK(object) {
        return {
            req: object.req ? types_1.RequestFinalizeBlock.fromSDK(object.req) : undefined,
            res: object.res ? types_1.ResponseFinalizeBlock.fromSDK(object.res) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.req !== undefined && (obj.req = message.req ? types_1.RequestFinalizeBlock.toSDK(message.req) : undefined);
        message.res !== undefined && (obj.res = message.res ? types_1.ResponseFinalizeBlock.toSDK(message.res) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
...
exports.ListenCommitRequest = {
    ...
    fromSDK(object) {
        return {
            ...
            res: object.res ? types_1.ResponseCommit.fromSDK(object.res) : undefined,
            change_set: Array.isArray(object?.change_set) ? object.change_set.map((e) => listening_1.StoreKVPair.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        obj.block_height = message.block_height;
        message.res !== undefined && (obj.res = message.res ? types_1.ResponseCommit.toSDK(message.res) : undefined);
        if (message.change_set) {
            obj.change_set = message.change_set.map(e => e ? listening_1.StoreKVPair.toSDK(e) : undefined);
        }
        else {
            obj.change_set = [];
        }
