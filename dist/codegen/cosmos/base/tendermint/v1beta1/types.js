...
exports.Header = {
    ...
    fromSDK(object) {
        return {
            ...
            last_block_id: object.last_block_id ? types_1.BlockID.fromSDK(object.last_block_id) : undefined,
    ...
    toSDK(message) {
        ...
        message.last_block_id !== undefined && (obj.last_block_id = message.last_block_id ? types_1.BlockID.toSDK(message.last_block_id) : undefined);
