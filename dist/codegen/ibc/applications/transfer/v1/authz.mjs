...
export const TransferAuthorization = {
    ...
    fromSDK(object) {
        return {
            allocations: Array.isArray(object?.allocations) ? object.allocations.map((e) => Allocation.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
    ...
    fromAmino(object) {
        return {
            allocations: Array.isArray(object?.allocations) ? object.allocations.map((e) => Allocation.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
