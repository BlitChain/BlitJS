...
export const GenesisState = {
    ...
    fromSDK(object) {
        return {
            clients: Array.isArray(object?.clients) ? object.clients.map((e) => IdentifiedClientState.fromSDK(e)) : [],
            clients_consensus: Array.isArray(object?.clients_consensus) ? object.clients_consensus.map((e) => ClientConsensusStates.fromSDK(e)) : [],
            clients_metadata: Array.isArray(object?.clients_metadata) ? object.clients_metadata.map((e) => IdentifiedGenesisMetadata.fromSDK(e)) : [],
...
export const IdentifiedGenesisMetadata = {
    ...
    fromSDK(object) {
        return {
            ...
            client_metadata: Array.isArray(object?.client_metadata) ? object.client_metadata.map((e) => GenesisMetadata.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
