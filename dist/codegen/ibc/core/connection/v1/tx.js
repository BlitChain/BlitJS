...
exports.MsgConnectionOpenTry = {
    ...
    fromSDK(object) {
        return {
            ...
            counterparty: object.counterparty ? connection_1.Counterparty.fromSDK(object.counterparty) : undefined,
            delay_period: object?.delay_period,
            counterparty_versions: Array.isArray(object?.counterparty_versions) ? object.counterparty_versions.map((e) => connection_1.Version.fromSDK(e)) : [],
            ...
            consensus_height: object.consensus_height ? client_1.Height.fromSDK(object.consensus_height) : undefined,
            signer: object?.signer,
    ...
    toSDK(message) {
        ...
        obj.delay_period = message.delay_period;
        if (message.counterparty_versions) {
            obj.counterparty_versions = message.counterparty_versions.map(e => e ? connection_1.Version.toSDK(e) : undefined);
        }
        else {
            obj.counterparty_versions = [];
        }
        ...
        message.consensus_height !== undefined && (obj.consensus_height = message.consensus_height ? client_1.Height.toSDK(message.consensus_height) : undefined);
        obj.signer = message.signer;
