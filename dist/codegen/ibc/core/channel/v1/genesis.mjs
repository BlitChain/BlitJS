...
export const GenesisState = {
    ...
    fromSDK(object) {
        return {
            ...
            receipts: Array.isArray(object?.receipts) ? object.receipts.map((e) => PacketState.fromSDK(e)) : [],
            send_sequences: Array.isArray(object?.send_sequences) ? object.send_sequences.map((e) => PacketSequence.fromSDK(e)) : [],
            recv_sequences: Array.isArray(object?.recv_sequences) ? object.recv_sequences.map((e) => PacketSequence.fromSDK(e)) : [],
            ack_sequences: Array.isArray(object?.ack_sequences) ? object.ack_sequences.map((e) => PacketSequence.fromSDK(e)) : [],
