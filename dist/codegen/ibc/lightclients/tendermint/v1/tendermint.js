...
exports.ClientState = {
    ...
    fromAmino(object) {
        ...
        if (object.trust_level !== undefined && object.trust_level !== null) {
            message.trust_level = exports.Fraction.fromAmino(object.trust_level);
        }
        if (object.trusting_period !== undefined && object.trusting_period !== null) {
            message.trusting_period = duration_1.Duration.fromAmino(object.trusting_period);
        }
        if (object.unbonding_period !== undefined && object.unbonding_period !== null) {
            message.unbonding_period = duration_1.Duration.fromAmino(object.unbonding_period);
        }
        if (object.max_clock_drift !== undefined && object.max_clock_drift !== null) {
            message.max_clock_drift = duration_1.Duration.fromAmino(object.max_clock_drift);
        }
        if (object.frozen_height !== undefined && object.frozen_height !== null) {
            message.frozen_height = client_1.Height.fromAmino(object.frozen_height);
        }
        if (object.latest_height !== undefined && object.latest_height !== null) {
            message.latest_height = client_1.Height.fromAmino(object.latest_height);
        }
        message.proof_specs = object.proof_specs?.map(e => proofs_1.ProofSpec.fromAmino(e)) || [];
        message.upgrade_path = object.upgrade_path?.map(e => e) || [];
...
exports.Misbehaviour = {
    ...
    fromAmino(object) {
        ...
        if (object.header_1 !== undefined && object.header_1 !== null) {
            message.header_1 = exports.Header.fromAmino(object.header_1);
        }
        if (object.header_2 !== undefined && object.header_2 !== null) {
            message.header_2 = exports.Header.fromAmino(object.header_2);
        }
        return message;
    },
    toAmino(message) {
...
exports.Header = {
    ...
    fromAmino(object) {
        ...
        if (object.signed_header !== undefined && object.signed_header !== null) {
            message.signed_header = types_1.SignedHeader.fromAmino(object.signed_header);
        }
        ...
        if (object.trusted_height !== undefined && object.trusted_height !== null) {
            message.trusted_height = client_1.Height.fromAmino(object.trusted_height);
        }
        if (object.trusted_validators !== undefined && object.trusted_validators !== null) {
            message.trusted_validators = validator_1.ValidatorSet.fromAmino(object.trusted_validators);
        }
        return message;
    },
    toAmino(message) {
