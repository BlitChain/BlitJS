    ...
    return {
        ...
        ibc: {
            applications: {
                interchain_accounts: {
                    controller: {
                        v1: new (await Promise.resolve().then(() => __importStar(require("./applications/interchain_accounts/controller/v1/query.rpc.Query")))).QueryClientImpl(endpoint)
                    },
                    host: {
                        v1: new (await Promise.resolve().then(() => __importStar(require("./applications/interchain_accounts/host/v1/query.rpc.Query")))).QueryClientImpl(endpoint)
                    }
                },
                transfer: {
                    v1: new (await Promise.resolve().then(() => __importStar(require("./applications/transfer/v1/query.rpc.Query")))).QueryClientImpl(endpoint)
                }
            },
            core: {
                channel: {
                    v1: new (await Promise.resolve().then(() => __importStar(require("./core/channel/v1/query.rpc.Query")))).QueryClientImpl(endpoint)
                },
                client: {
                    v1: new (await Promise.resolve().then(() => __importStar(require("./core/client/v1/query.rpc.Query")))).QueryClientImpl(endpoint)
                },
                connection: {
                    v1: new (await Promise.resolve().then(() => __importStar(require("./core/connection/v1/query.rpc.Query")))).QueryClientImpl(endpoint)
                }
            }
        }
    };
