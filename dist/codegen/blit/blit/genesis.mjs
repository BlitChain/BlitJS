...
export const GenesisState = {
    ...
    fromAmino(object) {
        return {
            ...
            task_list: Array.isArray(object?.task_list) ? object.task_list.map((e) => Task.fromAmino(e)) : [],
            future_task_list: Array.isArray(object?.future_task_list) ? object.future_task_list.map((e) => FutureTask.fromAmino(e)) : [],
