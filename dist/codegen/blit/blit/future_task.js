...
exports.FutureTask = {
    ...
    fromAmino(object) {
        return {
            index: object.index,
            scheduled_on: object?.scheduled_on ? (0, helpers_1.fromTimestamp)(timestamp_1.Timestamp.fromAmino(object.scheduled_on)) : undefined,
            task_id: BigInt(object.task_id),
            status: (0, helpers_1.isSet)(object.status) ? futureTaskStatusFromJSON(object.status) : -1,
            gas_price: object?.gas_price ? coin_1.DecCoin.fromAmino(object.gas_price) : undefined
        };
    },
    toAmino(message) {
        const obj = {};
