...
exports.QueryGetTaskResponse = {
    ...
    fromAmino(object) {
        return {
            task: object?.task ? task_1.Task.fromAmino(object.task) : undefined
        };
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryAllTaskResponse = {
    ...
    fromAmino(object) {
        return {
            task: Array.isArray(object?.task) ? object.task.map((e) => task_1.Task.fromAmino(e)) : [],
...
exports.QueryGetFutureTaskResponse = {
    ...
    fromAmino(object) {
        return {
            futureTask: object?.futureTask ? future_task_1.FutureTask.fromAmino(object.futureTask) : undefined
        };
    },
    toAmino(message) {
        const obj = {};
...
exports.QueryAllFutureTaskResponse = {
    ...
    fromAmino(object) {
        return {
            futureTask: Array.isArray(object?.futureTask) ? object.futureTask.map((e) => future_task_1.FutureTask.fromAmino(e)) : [],
            pagination: object?.pagination ? pagination_1.PageResponse.fromAmino(object.pagination) : undefined
        };
    },
    toAmino(message) {
