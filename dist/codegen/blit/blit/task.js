...
exports.Task = {
    ...
    fromAmino(object) {
        return {
            ...
            results: Array.isArray(object?.results) ? object.results.map((e) => abci_1.Result.fromAmino(e)) : [],
            last_executed_on: object?.last_executed_on ? (0, helpers_1.fromTimestamp)(timestamp_1.Timestamp.fromAmino(object.last_executed_on)) : undefined,
