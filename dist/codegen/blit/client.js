...
exports.getSigningBlitClient = exports.getSigningBlitClientOptions = exports.blitProtoRegistry = exports.blitAminoConverters = void 0;
//@ts-nocheck
...
exports.getSigningBlitClientOptions = getSigningBlitClientOptions;
const getSigningBlitClient = async ({ rpcEndpoint, signer, defaultTypes = stargate_1.defaultRegistryTypes }) => {
    const { registry, aminoTypes } = (0, exports.getSigningBlitClientOptions)({
        defaultTypes
    });
...
exports.getSigningBlitClient = getSigningBlitClient;
