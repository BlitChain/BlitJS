...
exports.BlockID = {
    ...
    fromSDK(object) {
        return {
            hash: object?.hash,
            part_set_header: object.part_set_header ? exports.PartSetHeader.fromSDK(object.part_set_header) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        obj.hash = message.hash;
        message.part_set_header !== undefined && (obj.part_set_header = message.part_set_header ? exports.PartSetHeader.toSDK(message.part_set_header) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
...
exports.Header = {
    ...
    fromSDK(object) {
        return {
            ...
            last_block_id: object.last_block_id ? exports.BlockID.fromSDK(object.last_block_id) : undefined,
    ...
    toSDK(message) {
        ...
        message.last_block_id !== undefined && (obj.last_block_id = message.last_block_id ? exports.BlockID.toSDK(message.last_block_id) : undefined);
...
exports.Vote = {
    ...
    fromSDK(object) {
        return {
            ...
            height: object?.height,
            round: object?.round,
            block_id: object.block_id ? exports.BlockID.fromSDK(object.block_id) : undefined,
    ...
    toSDK(message) {
        ...
        message.block_id !== undefined && (obj.block_id = message.block_id ? exports.BlockID.toSDK(message.block_id) : undefined);
...
exports.ExtendedCommit = {
    ...
    fromSDK(object) {
        return {
            ...
            round: object?.round,
            block_id: object.block_id ? exports.BlockID.fromSDK(object.block_id) : undefined,
            extended_signatures: Array.isArray(object?.extended_signatures) ? object.extended_signatures.map((e) => exports.ExtendedCommitSig.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
        ...
        message.block_id !== undefined && (obj.block_id = message.block_id ? exports.BlockID.toSDK(message.block_id) : undefined);
        if (message.extended_signatures) {
            obj.extended_signatures = message.extended_signatures.map(e => e ? exports.ExtendedCommitSig.toSDK(e) : undefined);
        }
        else {
            obj.extended_signatures = [];
        }
    ...
    fromAmino(object) {
        return {
            ...
            round: object.round,
            block_id: object?.block_id ? exports.BlockID.fromAmino(object.block_id) : undefined,
            extended_signatures: Array.isArray(object?.extended_signatures) ? object.extended_signatures.map((e) => exports.ExtendedCommitSig.fromAmino(e)) : []
        };
    },
    toAmino(message) {
        const obj = {};
...
exports.LightBlock = {
    ...
    fromSDK(object) {
        return {
            signed_header: object.signed_header ? exports.SignedHeader.fromSDK(object.signed_header) : undefined,
            validator_set: object.validator_set ? validator_1.ValidatorSet.fromSDK(object.validator_set) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        message.signed_header !== undefined && (obj.signed_header = message.signed_header ? exports.SignedHeader.toSDK(message.signed_header) : undefined);
...
exports.BlockMeta = {
    ...
    fromAmino(object) {
        return {
            block_id: object?.block_id ? exports.BlockID.fromAmino(object.block_id) : undefined,
            block_size: BigInt(object.block_size),
            header: object?.header ? exports.Header.fromAmino(object.header) : undefined,
            num_txs: BigInt(object.num_txs)
        };
    },
    toAmino(message) {
        const obj = {};
