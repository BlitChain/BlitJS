...
export const LightClientAttackEvidence = {
    ...
    fromSDK(object) {
        return {
            ...
            byzantine_validators: Array.isArray(object?.byzantine_validators) ? object.byzantine_validators.map((e) => Validator.fromSDK(e)) : [],
            total_voting_power: object?.total_voting_power,
            timestamp: object.timestamp ? Timestamp.fromSDK(object.timestamp) : undefined
        };
    },
...
export const EvidenceList = {
    ...
    fromSDK(object) {
        return {
            evidence: Array.isArray(object?.evidence) ? object.evidence.map((e) => Evidence.fromSDK(e)) : []
        };
    },
    toSDK(message) {
        const obj = {};
