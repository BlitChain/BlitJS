...
exports.PeerInfo = {
    ...
    fromSDK(object) {
        return {
            id: object?.id,
            address_info: Array.isArray(object?.address_info) ? object.address_info.map((e) => exports.PeerAddressInfo.fromSDK(e)) : [],
            last_connected: object.last_connected ? timestamp_1.Timestamp.fromSDK(object.last_connected) : undefined
        };
    },
    toSDK(message) {
        const obj = {};
        obj.id = message.id;
        if (message.address_info) {
            obj.address_info = message.address_info.map(e => e ? exports.PeerAddressInfo.toSDK(e) : undefined);
        }
        else {
            obj.address_info = [];
        }
        message.last_connected !== undefined && (obj.last_connected = message.last_connected ? timestamp_1.Timestamp.toSDK(message.last_connected) : undefined);
        return obj;
    },
    fromAmino(object) {
        return {
            ...
            last_connected: object?.last_connected ? (0, helpers_1.fromTimestamp)(timestamp_1.Timestamp.fromAmino(object.last_connected)) : undefined
        };
    },
    toAmino(message) {
        const obj = {};
        ...
        obj.last_connected = message.last_connected ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.last_connected)) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.PeerAddressInfo = {
    ...
    fromSDK(object) {
        return {
            ...
            last_dial_success: object.last_dial_success ? timestamp_1.Timestamp.fromSDK(object.last_dial_success) : undefined,
            last_dial_failure: object.last_dial_failure ? timestamp_1.Timestamp.fromSDK(object.last_dial_failure) : undefined,
    ...
    toSDK(message) {
        ...
        message.last_dial_success !== undefined && (obj.last_dial_success = message.last_dial_success ? timestamp_1.Timestamp.toSDK(message.last_dial_success) : undefined);
        message.last_dial_failure !== undefined && (obj.last_dial_failure = message.last_dial_failure ? timestamp_1.Timestamp.toSDK(message.last_dial_failure) : undefined);
    ...
    fromAmino(object) {
        return {
            address: object.address,
            last_dial_success: object?.last_dial_success ? (0, helpers_1.fromTimestamp)(timestamp_1.Timestamp.fromAmino(object.last_dial_success)) : undefined,
            last_dial_failure: object?.last_dial_failure ? (0, helpers_1.fromTimestamp)(timestamp_1.Timestamp.fromAmino(object.last_dial_failure)) : undefined,
            dial_failures: object.dial_failures
        };
    },
    toAmino(message) {
        const obj = {};
        obj.address = message.address;
        obj.last_dial_success = message.last_dial_success ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.last_dial_success)) : undefined;
        obj.last_dial_failure = message.last_dial_failure ? timestamp_1.Timestamp.toAmino((0, helpers_1.toTimestamp)(message.last_dial_failure)) : undefined;
        obj.dial_failures = message.dial_failures;
        return obj;
    },
    fromAminoMsg(object) {
