...
export declare const makeQueryClient: ({ restEndpoint }: {
    restEndpoint: any;
}) => Promise<{
    blit: {
...
export declare const makeKeplrClient: ({ rpcEndpoint, restEndpoint, chainId }: {
    rpcEndpoint: any;
    restEndpoint: any;
    chainId: any;
}) => Promise<unknown>;
export declare const runFunction: ({ msgClient, caller_address, script_address, function_name, kwargs, extra_code, grantee }: {
    msgClient: any;
    caller_address: any;
    script_address: any;
    function_name: any;
...
export declare const queryFunction: ({ queryClient, script_address, caller_address, function_name, kwargs, extra_code, grantee }: {
    queryClient: any;
    script_address: any;
    caller_address: any;
    function_name: any;
