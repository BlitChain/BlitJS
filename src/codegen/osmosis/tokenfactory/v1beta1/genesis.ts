...
export const GenesisState = {
  ...
  fromSDK(object: GenesisStateSDKType): GenesisState {
    return {
      ...
      factory_denoms: Array.isArray(object?.factory_denoms) ? object.factory_denoms.map((e: any) => GenesisDenom.fromSDK(e)) : []
    };
  },
  toSDK(message: GenesisState): GenesisStateSDKType {
    ...
    if (message.factory_denoms) {
      obj.factory_denoms = message.factory_denoms.map(e => e ? GenesisDenom.toSDK(e) : undefined);
    } else {
      obj.factory_denoms = [];
    }
    return obj;
