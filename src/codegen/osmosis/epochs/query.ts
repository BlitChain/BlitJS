...
export interface QueryEpochsInfoRequestProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryEpochsInfoRequest";
  value: Uint8Array;
}
export interface QueryEpochsInfoRequestProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryEpochsInfoRequest";
...
export interface QueryEpochsInfoResponseProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryEpochsInfoResponse";
  value: Uint8Array;
}
export interface QueryEpochsInfoResponseProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryEpochsInfoResponse";
...
export interface QueryCurrentEpochRequestProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryCurrentEpochRequest";
  value: Uint8Array;
}
export interface QueryCurrentEpochRequestProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryCurrentEpochRequest";
...
export interface QueryCurrentEpochResponseProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryCurrentEpochResponse";
  value: Uint8Array;
}
export interface QueryCurrentEpochResponseProtoMsg {
  type_url: "/osmosis.epochs.v1beta1.QueryCurrentEpochResponse";
