...
export interface MsgSetHotRoutes {
  ...
  hot_routes: TokenPairArbRoutes[];
}
export interface MsgSetHotRoutesProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetHotRoutes";
  value: Uint8Array;
}
export interface MsgSetHotRoutesProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetHotRoutes";
...
export interface MsgSetHotRoutesResponseProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetHotRoutesResponse";
  value: Uint8Array;
}
export interface MsgSetHotRoutesResponseProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetHotRoutesResponse";
...
export interface MsgSetDeveloperAccountProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetDeveloperAccount";
  value: Uint8Array;
}
export interface MsgSetDeveloperAccountProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetDeveloperAccount";
...
export interface MsgSetDeveloperAccountResponseProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetDeveloperAccountResponse";
  value: Uint8Array;
}
export interface MsgSetDeveloperAccountResponseProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.MsgSetDeveloperAccountResponse";
...
export const MsgSetHotRoutes = {
  ...
  fromJSON(object: any): MsgSetHotRoutes {
    return {
      ...
      hot_routes: Array.isArray(object?.hot_routes) ? object.hot_routes.map((e: any) => TokenPairArbRoutes.fromJSON(e)) : []
    };
  },
  ...
  fromSDK(object: MsgSetHotRoutesSDKType): MsgSetHotRoutes {
    return {
      admin: object?.admin,
      hot_routes: Array.isArray(object?.hot_routes) ? object.hot_routes.map((e: any) => TokenPairArbRoutes.fromSDK(e)) : []
    };
  },
  ...
  fromAmino(object: MsgSetHotRoutesAmino): MsgSetHotRoutes {
    return {
      admin: object.admin,
      hot_routes: Array.isArray(object?.hot_routes) ? object.hot_routes.map((e: any) => TokenPairArbRoutes.fromAmino(e)) : []
    };
  },
