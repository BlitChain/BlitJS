...
export interface TokenPairArbRoutesProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.TokenPairArbRoutes";
  value: Uint8Array;
}
export interface TokenPairArbRoutesProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.TokenPairArbRoutes";
...
export interface RouteProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.Route";
  value: Uint8Array;
}
export interface RouteProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.Route";
...
export interface TradeProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.Trade";
  value: Uint8Array;
}
export interface TradeProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.Trade";
...
export interface PoolStatisticsProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.PoolStatistics";
  value: Uint8Array;
}
export interface PoolStatisticsProtoMsg {
  type_url: "/osmosis.protorev.v1beta1.PoolStatistics";
...
export const TokenPairArbRoutes = {
  ...
  fromJSON(object: any): TokenPairArbRoutes {
    return {
      arb_routes: Array.isArray(object?.arb_routes) ? object.arb_routes.map((e: any) => Route.fromJSON(e)) : [],
  ...
  fromSDK(object: TokenPairArbRoutesSDKType): TokenPairArbRoutes {
    return {
      arb_routes: Array.isArray(object?.arb_routes) ? object.arb_routes.map((e: any) => Route.fromSDK(e)) : [],
  ...
  fromAmino(object: TokenPairArbRoutesAmino): TokenPairArbRoutes {
    return {
      arb_routes: Array.isArray(object?.arb_routes) ? object.arb_routes.map((e: any) => Route.fromAmino(e)) : [],
      token_in: object.token_in,
      token_out: object.token_out
    };
  },
