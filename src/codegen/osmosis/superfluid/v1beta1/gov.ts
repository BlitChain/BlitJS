...
export interface SetSuperfluidAssetsProposalProtoMsg {
  type_url: "/osmosis.superfluid.v1beta1.SetSuperfluidAssetsProposal";
  value: Uint8Array;
}
export interface SetSuperfluidAssetsProposalProtoMsg {
  type_url: "/osmosis.superfluid.v1beta1.SetSuperfluidAssetsProposal";
...
export interface RemoveSuperfluidAssetsProposalProtoMsg {
  type_url: "/osmosis.superfluid.v1beta1.RemoveSuperfluidAssetsProposal";
  value: Uint8Array;
}
export interface RemoveSuperfluidAssetsProposalProtoMsg {
  type_url: "/osmosis.superfluid.v1beta1.RemoveSuperfluidAssetsProposal";
...
export interface UpdateUnpoolWhiteListProposalProtoMsg {
  type_url: "/osmosis.superfluid.v1beta1.UpdateUnpoolWhiteListProposal";
  value: Uint8Array;
}
export interface UpdateUnpoolWhiteListProposalProtoMsg {
  type_url: "/osmosis.superfluid.v1beta1.UpdateUnpoolWhiteListProposal";
...
export const RemoveSuperfluidAssetsProposal = {
  ...
  fromSDK(object: RemoveSuperfluidAssetsProposalSDKType): RemoveSuperfluidAssetsProposal {
    return {
      title: object?.title,
      description: object?.description,
      superfluid_asset_denoms: Array.isArray(object?.superfluid_asset_denoms) ? object.superfluid_asset_denoms.map((e: any) => e) : []
    };
  },
