...
export const ModuleDescriptor = {
  ...
  fromAmino(object: ModuleDescriptorAmino): ModuleDescriptor {
    return {
      ...
      use_package: Array.isArray(object?.use_package) ? object.use_package.map((e: any) => PackageReference.fromAmino(e)) : [],
      can_migrate_from: Array.isArray(object?.can_migrate_from) ? object.can_migrate_from.map((e: any) => MigrateFromInfo.fromAmino(e)) : []
    };
  },
