...
export const GenesisState = {
  ...
  fromSDK(object: GenesisStateSDKType): GenesisState {
    return {
      account_permissions: Array.isArray(object?.account_permissions) ? object.account_permissions.map((e: any) => GenesisAccountPermissions.fromSDK(e)) : [],
  ...
  toSDK(message: GenesisState): GenesisStateSDKType {
    const obj: any = {};
    if (message.account_permissions) {
      obj.account_permissions = message.account_permissions.map(e => e ? GenesisAccountPermissions.toSDK(e) : undefined);
    } else {
      obj.account_permissions = [];
    }
    if (message.disabled_type_urls) {
