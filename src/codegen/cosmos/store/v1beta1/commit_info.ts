...
export const CommitInfo = {
  ...
  fromSDK(object: CommitInfoSDKType): CommitInfo {
    return {
      ...
      store_infos: Array.isArray(object?.store_infos) ? object.store_infos.map((e: any) => StoreInfo.fromSDK(e)) : [],
  ...
  toSDK(message: CommitInfo): CommitInfoSDKType {
    ...
    if (message.store_infos) {
      obj.store_infos = message.store_infos.map(e => e ? StoreInfo.toSDK(e) : undefined);
    } else {
      obj.store_infos = [];
    }
  ...
  fromAmino(object: CommitInfoAmino): CommitInfo {
    return {
      ...
      store_infos: Array.isArray(object?.store_infos) ? object.store_infos.map((e: any) => StoreInfo.fromAmino(e)) : [],
...
export const StoreInfo = {
  ...
  fromSDK(object: StoreInfoSDKType): StoreInfo {
    return {
      name: object?.name,
      commit_id: object.commit_id ? CommitID.fromSDK(object.commit_id) : undefined
    };
  },
  toSDK(message: StoreInfo): StoreInfoSDKType {
    const obj: any = {};
    obj.name = message.name;
    message.commit_id !== undefined && (obj.commit_id = message.commit_id ? CommitID.toSDK(message.commit_id) : undefined);
    return obj;
  },
