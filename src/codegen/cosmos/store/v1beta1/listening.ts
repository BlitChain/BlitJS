...
export const BlockMetadata = {
  ...
  fromSDK(object: BlockMetadataSDKType): BlockMetadata {
    return {
      response_commit: object.response_commit ? ResponseCommit.fromSDK(object.response_commit) : undefined,
      request_finalize_block: object.request_finalize_block ? RequestFinalizeBlock.fromSDK(object.request_finalize_block) : undefined,
      response_finalize_block: object.response_finalize_block ? ResponseFinalizeBlock.fromSDK(object.response_finalize_block) : undefined
    };
  },
  toSDK(message: BlockMetadata): BlockMetadataSDKType {
    const obj: any = {};
    message.response_commit !== undefined && (obj.response_commit = message.response_commit ? ResponseCommit.toSDK(message.response_commit) : undefined);
    message.request_finalize_block !== undefined && (obj.request_finalize_block = message.request_finalize_block ? RequestFinalizeBlock.toSDK(message.request_finalize_block) : undefined);
    message.response_finalize_block !== undefined && (obj.response_finalize_block = message.response_finalize_block ? ResponseFinalizeBlock.toSDK(message.response_finalize_block) : undefined);
    return obj;
  },
