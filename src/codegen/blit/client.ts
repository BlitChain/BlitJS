...
export const blitProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...blitBlitTxRegistry.registry, ...blitScriptTxRegistry.registry, ...blitStorageTxRegistry.registry, ...blitTxRegistry.registry];
