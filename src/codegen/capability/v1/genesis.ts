...
export interface GenesisOwnersProtoMsg {
  type_url: "/capability.v1.GenesisOwners";
  value: Uint8Array;
}
/** GenesisOwners defines the capability owners with their corresponding index. */
...
export interface GenesisStateProtoMsg {
  type_url: "/capability.v1.GenesisState";
  value: Uint8Array;
}
/** GenesisState defines the capability module's genesis state. */
...
export const GenesisOwners = {
  ...
  fromAmino(object: GenesisOwnersAmino): GenesisOwners {
    return {
      ...
      index_owners: object?.index_owners ? CapabilityOwners.fromAmino(object.index_owners) : undefined
    };
  },
  toAmino(message: GenesisOwners): GenesisOwnersAmino {
    const obj: any = {};
    obj.index = message.index ? message.index.toString() : undefined;
    obj.index_owners = message.index_owners ? CapabilityOwners.toAmino(message.index_owners) : undefined;
    return obj;
  },
